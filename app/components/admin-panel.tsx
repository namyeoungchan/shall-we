...
export function AdminPanel() {
  ...
  return <div className="admin-shell">
    ...
    <main className="admin-main">
      ...
      <section className="admin-section"><div className="admin-section-head"><span>03 / FREEZE</span><h2>약속의 선언</h2></div><div className="field-grid"><Field label="코드" value={content.freeze.code} onChange={(code) => setContent({ ...content, freeze: { ...content.freeze, code } })} /><Field label="제목" value={content.freeze.title} onChange={(title) => setContent({ ...content, freeze: { ...content.freeze, title } })} /><Field wide area label="본문" value={content.freeze.text} onChange={(text) => setContent({ ...content, freeze: { ...content.freeze, text } })} /></div></section>
